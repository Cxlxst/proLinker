  ...
  function register() {
    ...
    return (
        <BackgroundGradientAnimation>
            ...
            <button onClick={register} className="absolute z-50 cursor-pointer hover:bg-pink-700 transition p-3 rounded-lg transition duration-300" style={{ top: '65%', left: '50%', transform: 'translate(-50%, -50%)' }} >
                M'inscrire
            </button>
