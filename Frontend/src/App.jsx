...
function App() {
    ...
    const linksLog = [
        ...
        },
        {
            label: "Tous les CV",
            href: "/liste-cv",
            icon: <IconListSearch className="text-white h-5 w-5 flex-shrink-0" />,
        },
        {
            label: "Curriculum vitæ",
            href: "/modifier-mon-cv",
            icon: <IconFileCv className="text-white h-5 w-5 flex-shrink-0" />,
        },
        {
            label: "Paramètres",
            href: "/parametres",
        ...
        {
            label: "Déconnexion",
            icon: <IconLogout className="text-white h-5 w-5 flex-shrink-0" />,
            href: "/connexion",
            func: () => {logout()},
        },
    ];
    ...
    return (
        <Router>
            <div
                className={cn("rounded-md flex flex-col md:flex-row bg-gray-100 dark:bg-neutral-800 w-screen h-screen flex-1 mx-auto overflow-hidden")}
            >
